...
func testSetHead(t *testing.T, tt *rewindTest) {
	...
	fmt.Println("Detect CurrentBlock", chain.CurrentBlock())
	...
	for i := uint64(0); i <= chain.CurrentHeader().Number.Uint64(); i++ {
		fmt.Println("Detect block", chain.GetBlockByNumber(i))
	}

	fmt.Println("Detect CurrentHeader", chain.GetBlockByNumber(0))

	fmt.Println("Detect CurrentHeader", chain.CurrentHeader())
	fmt.Println("Detect CurrentFastBlock", chain.CurrentFastBlock())
	fmt.Println("Detect CurrentBlock", chain.CurrentBlock())
